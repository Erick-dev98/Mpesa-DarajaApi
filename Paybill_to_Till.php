...
$initiator = "testapi";
$amount = "1";
$partyA = "600584"; // Business short code
$partyB = "000000"; // Merchant's short code or till number
$accountReference = "353353"; // A unique reference number for the transaction
$requester = "254000000000"; // Phone number of the person making the request
$remarks = "OK"; // Optional remarks for the transaction
$queueTimeOutURL = "https://bb55-197-237-132-56.ngrok-free.app/darajaapi/Paybill_to_Paybill_Callback.php";
$resultURL = "https://bb55-197-237-132-56.ngrok-free.app/darajaapi/Paybill_to_Paybill_Callback.php";
